...
useEffect(() => {
    ...
    <div>
      ...
      <section className="hero_section">
        <div className="hero_left">
          ...
          <p>
            Every non-perishable food item you donate<br />
            goes direct to individuals and families in<br />
      ...
      <section className="donate-section">
        <div className="tab-header">
          {["Donate Non-Perishable Food", "Choose the Box", "Donate Financially", "Host a Food Drive"].map((tab, index) => (
            <button
              key={index}
          ...
          <>
            <div className="donate-content">
              <div className="donate-left">
                <h3>We accept a wide variety of non-perishable food donations</h3>
                <ul>
                  <li><FaCheckCircle className="icon" /> Canned goods (vegetables, fruits, soups, beans, meats, etc.)</li>
                  <li><FaCheckCircle className="icon" /> Dry foods (rice, cereal, lentils, flour, etc.)</li>
                  <li><FaCheckCircle className="icon" /> Baby food</li>
                  <li><FaCheckCircle className="icon" /> Cooking oil and spices</li>
                </ul>
              </div>
            ...
            <p className="donate-info">
              Donating food is as simple as dropping off your items at our donation centers or participating in a food drive event.<br />
              If you are in Chennai you can visit our Goodgive Food bank stall at YMCA Vepery for drop-off.
            </p>
            ...
            <div className="donation-cards">
              <div className="donation-card">
                <div className="donation-card-content">
                  <h4>YMCA - Nandanam</h4>
                  <p>497, Anna Salai, YMCA College <br /> of Physical Education, Nandanam, <br /> Chennai, Tamil Nadu - 600035.</p>
              ...
              <div className="donation-card">
                <div className="donation-card-content">
                  ...
                  <p>27th Street, 7th Avenue, Physical <br /> Education, Royapettah, Chennai, <br /> Tamil Nadu - 600014.</p>
                  <a href="#" className="direction-link">Get Direction</a>
                </div>
      ...
      {activeTab === 1 && (
        <div className="choose-box-section">
          <p className="choose-box-desc">
            If you’d prefer to donate by choosing the food item that you want to donate,
            you can view the options available in the <br /> <strong>Food-box menu</strong>.
            We will use your contribution to purchase food and the same combination of
            items will be <br /> consolidated in a Food-box and the same will be delivered to one family.
          </p>

          <div className="image-grid">
            {[
              { name: "Green Box", image: "/images/greenbox.png", amount: "₹500" },
              { name: "Blue Box", image: "/images/bluebox.png", amount: "₹1,000" },
              { name: "Red Box", image: "/images/redbox.png", amount: "₹1,500" },
              { name: "Silver Box", image: "/images/silverbox.png", amount: "₹2,000" },
              { name: "Gold Box", image: "/images/goldbox.png", amount: "₹2,500" },
              { name: "Platinum Box", image: "/images/platinumbox.png", amount: "₹3,000" },
            ].map((item, index) => (
                ...
                <div className="item-footer">
                  ...
                  {cartItems[item.name] ? (
                    <div className="quantity-box">
                      <button onClick={() => handleIncrease(item.name)} className="qty-btn">+</button>
                      <span className="qty-count">{cartItems[item.name]}</span>
                      <button onClick={() => handleDecrease(item.name)} className="qty-btn">−</button>
                    </div>
                  ) : (
                    <button className="add-btn" onClick={() => handleAdd(item.name)}>ADD</button>
                  )}
                </div>
              </div>
            ))}
  ...
  <div className="tab_panel">
    ...
    <p>
      If you'd prefer to donate money, we can use your contribution to purchase food in bulk,
      maintain our operations, <br/> and support our community outreach programs. A small donation can go
      a long way in providing essential meals to <br/> families in need.
    </p>
    ...
    <p className="give_once_desc">Please select your donation amount (*1 meal ₹25/-)</p>
  ...
  <div className="tab-panel">
    <p className="food-drive-intro">
      Consider organizing a food drive at your school, workplace, or community center.
      We can provide guidance on how to run an effective drive and ensure your efforts
...
<div className="form-row">
  ...
  <p className="impact-subtext">
    Every non-perishable food item you donate goes directly to individuals and families in need.
    Here's how your donation will make a real difference:
  </p>
  ...
  <div className="impact-grid">
    <div className="impact-card">
      ...
      <p>Your food donations help us offer balanced, nutritious <br/> meals to those who might otherwise go without.</p>
    </div>
    <div className="impact-card">
      <img src="/images/SVC.png" alt="Supporting Vulnerable Communities" />
      <h3>Supporting Vulnerable Communities</h3>
      <p>Children, the elderly, single parents, and people facing <br/> unemployment or emergencies rely on food banks like <br/> ours. Your contributions give them one less thing to <br/> worry about.</p>
    </div>
    <div className="impact-card">
      <img src="/images/RFW.png" alt="Reducing Food Waste" />
      <h3>Reducing Food Waste</h3>
      <p>Every time you donate non-perishable food, you <br/> help prevent perfectly good food from ending up <br/> in landfills while providing to those who need it.</p>
    </div>
    <div className="impact-card">
      <img src="/images/BSC.png" alt="Building Stronger Communities" />
      <h3>Building Stronger Communities</h3>
      <p>By participating in our food drive or making a regular <br/> donation, you're helping to create a stronger, more <br/> supportive community where we can all care for each other.</p>
    </div>
  </div>
</section>
